...
- **wplucas**, **msgauna**, **nnahra**, **tomlooi**:
	...
	<li> wplucas and msgauna focused on implementing the majority of methods within ReliabilityAnalysis.java; methods implemented were:
 	...
 	<li> nnahra and tomlooi focused on testwriting and artifact updates; tests implemented were:
		<ul>
 		<li>testVerifyReliabilitiesExample4()
 		<li>testVerifyReliabiltiesStressTest4()
 		<li>testVerifyReliabilitiesExample4NumFaults()
 		<li>testCreateHeaderRowExample4()
 		<li>testCreateHeaderRowPush_ExampleCustomInput1()
 		<li>testCreateHeaderRowPushAndPull_ExampleCustomInput2()
 		<li>testCreateHeaderRowOtherKeywords_ExampleCustomInput3()
 		<li>testHeaderRowHashMapExample4()
 		<li>testCreateDummyRowExample4()
 		<li>testCreateFirstRowExample4()
		<li>testCalculateNewSinkNodeStateExample4()
		<li>testCalculateNewSinkNodeStateAfterPeriodExample4()
		<li>testCalculateNewSinkNodeStateLastEntryExample4()
 		<li>getFlowSizeExample4()
 		<li>getFlowSizeExample1a()
 		<li>getFlowSizeStressTest4FirstFlow()
 		<li>getFlowSizeStressTest4LastFlow()
 		<li>getFlowSizeStressTest4MiddleFlow()
 		<li>testCheckRowForPeriodExample4()
 		<li>testCheckRowForPeriodStressTest4_Period1()
 		<li>testCheckRowForPeriodStressTest4_PeriodForMultipleFlows()
 		<li>testBuildReliabilityTableExample4()
		<li>testBuildReliabilityTablePeriodCheckExample4()
		<li>testBuildReliabilityTableCheckNodeNamesWithPush_ExampleCustomInput1()
		<li>testBuildReliabilitiyTableStressTest4FirstRow()
		<li>testBuildReliabilitiyTablePullFlowNameDiffForPushNameStressTest4()
		<li>testBuildReliabilityExample4NumFaultsRow0()
		<li>testBuildReliabilityExample4NumFaultsLast()
		<li>testBuildReliabilityStressTest4_M_95()
		<li>testBuildReliabilitiyTableExample4DiagonalRow()
 		</ul>
	<li> 
	</ul>
